...
const SignInPage = () => {
    const [formData, setFormData] = useState({email:'', password: ''});
        const handleClick =() =>{
            console.log("Data from the login form",formData)
        }
    return <>
            ...
            <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4">
                <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl max-md:max-w-md w-full">
                    <div>
                        ...
                        <p className="text-sm mt-12 text-gray-800">Don't have an account <Link href="/register" className="text-blue-600 font-semibold hover:underline ml-1">Register here</Link></p>
                    </div>
                    ...
                    <form className="max-w-md md:ml-auto w-full">
                        ...
                        <div className="!mt-8">
                            <button 
                            onClick={handleClick}
                            type="button" className="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                                Log in
                            </button>
                        </div>
