          ...
          {session?.user ? (
            <>
              ...
              <button
                ...
                className="text-sm bg-gray-100 hover:bg-red-600 hover:text-white px-3 py-1 rounded-2xl transition"
              >
                Logout
              </button>
            </>
            ...
            <button
              ...
              className="text-sm bg-blue-600 text-white px-4 py-1.5 rounded-2xl hover:bg-blue-700 transition"
            >
              Login / Register
            </button>
          )}
